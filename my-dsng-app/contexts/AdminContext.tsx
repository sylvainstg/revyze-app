...
export const AdminProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
    const [impersonatedRole, setImpersonatedRole] = useState<ProjectRole | null>(null);
    const [isAdminMode, setIsAdminMode] = useState(false);

    const toggleAdminMode = () => setIsAdminMode(prev => !prev);

    return (
        <AdminContext.Provider value={{ impersonatedRole, setImpersonatedRole, isAdminMode, toggleAdminMode }}>
            {children}
