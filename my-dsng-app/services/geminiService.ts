...
export const analyzeDesignArea = async (base64Image: string, context?: string): Promise<string> => {
  if (!apiKey) return "Gemini API Key is missing. Please check your environment.";
