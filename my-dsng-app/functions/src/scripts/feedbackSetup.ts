...
const main = async () => {
  console.log(
    "Backfilling feedback fields and ensuring sample campaign exists...",
  );
  ...
  console.log(
    `Updated ${userUpdates.length} users with lastFeedbackRequestedAt`,
  );
