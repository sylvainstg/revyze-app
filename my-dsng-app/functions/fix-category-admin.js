...
async function fixCategory() {
    try {
        ...
        console.log('   Category version:', latestVersion.categoryVersionNumber || 'N/A');
        console.log('   Uploaded:', new Date(latestVersion.timestamp).toLocaleString());
        ...
        const electricVersions = projectData.versions.filter(v => v.category === 'Electrique');
