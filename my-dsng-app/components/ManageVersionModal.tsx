                ...
                .map((category) => (
                  <label
                    ...
                    className={`flex items-center gap-3 p-3 rounded-lg border-2 cursor-pointer transition-all ${
                      !isNewCategory && selectedCategory === category
          ...
          <div className="border-t border-slate-100 pt-4">
            ...
            >
              <div className="flex items-center gap-2">
                <h4 className="text-sm font-semibold text-red-700 uppercase tracking-wider text-[10px]">
                  Danger Zone
                </h4>
                {showDangerZone ? (
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-red-600 leading-relaxed">
                      This will permanently remove the file and all associated
                      comments. If this is the only version in its category, the
                      category will also disappear.
                    </p>
                  </div>
                </div>
