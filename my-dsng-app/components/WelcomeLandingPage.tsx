...
import { Check, Sparkles, Users, Zap, FolderOpen, ShieldCheck, MessageSquare, ArrowRight } from 'lucide-react';
            ...
            <main className="flex-1 flex flex-col items-center justify-center p-6 md:p-12 max-w-4xl mx-auto w-full">
                ...
                <div className="text-center mb-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
                    ...
                    <p className="text-xl text-slate-600 max-w-2xl mx-auto">
                        <span className="font-semibold text-indigo-600">{displayName}</span> invited you to share your thoughts on the design of <span className="font-semibold text-indigo-600">{projectName || "their home"}</span>.
                    </p>
                </div>
                ...
                <div className="grid md:grid-cols-3 gap-8 w-full mb-12">
                    {[
                        ...
                        <div key={i} className="bg-white rounded-2xl p-6 border border-slate-100 shadow-sm relative animate-in fade-in slide-in-from-bottom-8 duration-700 delay-100">
                            <div className={`w-12 h-12 ${item.color} rounded-xl flex items-center justify-center mb-4`}>
                                {item.icon}
                            </div>
                            <div className="absolute top-6 right-6 text-slate-200 font-bold text-xl">0{item.step}</div>
