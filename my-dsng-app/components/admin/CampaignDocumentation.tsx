          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="p-4 rounded-lg border border-slate-200 bg-slate-50">
              <div className="flex items-center gap-2 mb-2">
                ...
                <code className="text-xs bg-slate-200 px-1.5 py-0.5 rounded text-slate-600">
                  segment: giving_up_almost
                </code>
              </div>
              <p className="text-sm text-slate-600 mb-2">
                New-ish free users on their 2nd+ session who poked around but
                returned slowly or had a very short last session.
              </p>
              <ul className="text-xs text-slate-500 list-disc list-inside space-y-1">
                <li>Account age: ≤ 30 days</li>
                <li>Plan: free, loginCount ≥ 2</li>
                <li>
                  Short last session (&lt; 3m) OR return after &gt; 2 days
                </li>
                <li>
                  Some engagement: ≥2 actions (project/comment/share/pan/zoom)
                </li>
              </ul>
              <div className="flex items-center gap-3 mt-3">
                ...
                >
                  {segmentLoading["giving_up_almost"]
                    ? "Loading…"
                    : "View users"}
                </button>
                ...
                <div className="mt-2 bg-white border border-slate-200 rounded p-2 text-xs text-slate-700">
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold">
                      {segmentUsers["giving_up_almost"].totalCount}
                    </span>
                  </div>
            ...
            <div className="p-4 rounded-lg border border-slate-200 bg-slate-50">
              ...
              <p className="text-sm text-slate-600 mb-2">
                Highly engaged users on paid plans.
              </p>
              <ul className="text-xs text-slate-500 list-disc list-inside space-y-1">
                <li>
                  Plan: <strong>Pro</strong> or <strong>Business</strong>
                </li>
                <li>
                  Engagement Score: <strong>≥ 70</strong>
                </li>
              </ul>
              <div className="flex items-center gap-3 mt-3">
                <button
              ...
              {segmentUsers["power_users"] && (
                <div className="mt-2 bg-white border border-slate-200 rounded p-2 text-xs text-slate-700">
                  <div className="flex justify-between">
                    <span>Total:</span>
                    <span className="font-semibold">
                      {segmentUsers["power_users"].totalCount}
                    </span>
                  </div>
            ...
            <div className="p-4 rounded-lg border border-slate-200 bg-slate-50">
              ...
              <p className="text-sm text-slate-600 mb-2">
                Paid users showing signs of churn.
              </p>
              <ul className="text-xs text-slate-500 list-disc list-inside space-y-1">
                <li>
                  Plan: <strong>Pro</strong> or <strong>Business</strong>
                ...
                <li>
                  <strong>OR</strong> Inactive &gt; 30 days
                </li>
                <li>
                  <strong>OR</strong> Engagement Score &lt; 40
                </li>
              </ul>
              <div className="flex items-center gap-3 mt-3">
                <button
              ...
              {segmentUsers["at_risk_pros"] && (
                <div className="mt-2 bg-white border border-slate-200 rounded p-2 text-xs text-slate-700">
                  <div className="flex justify-between">
                    <span>Total:</span>
                    <span className="font-semibold">
                      {segmentUsers["at_risk_pros"].totalCount}
                    </span>
                  </div>
            ...
            <div className="p-4 rounded-lg border border-slate-200 bg-slate-50">
              ...
              <p className="text-sm text-slate-600 mb-2">
                Recently signed up users who haven't started yet.
              </p>
              <ul className="text-xs text-slate-500 list-disc list-inside space-y-1">
                <li>
                  Account Age: <strong>≤ 7 days</strong>
                </li>
                <li>
                  Project Count: <strong>0</strong>
                </li>
              </ul>
              <div className="flex items-center gap-3 mt-3">
                <button
              ...
              {segmentUsers["new_users"] && (
                <div className="mt-2 bg-white border border-slate-200 rounded p-2 text-xs text-slate-700">
                  <div className="flex justify-between">
                    <span>Total:</span>
                    <span className="font-semibold">
                      {segmentUsers["new_users"].totalCount}
                    </span>
                  </div>
            ...
            <div className="p-4 rounded-lg border border-slate-200 bg-slate-50">
              ...
              <p className="text-sm text-slate-600 mb-2">
                Users logging in after a long absence.
              </p>
              <ul className="text-xs text-slate-500 list-disc list-inside space-y-1">
                <li>
                  Current Session: <strong>Active now</strong> (&lt; 24h)
                </li>
                <li>
                  Previous Login: <strong>&gt; 30 days ago</strong>
                </li>
              </ul>
              <div className="flex items-center gap-3 mt-3">
                <button
                ...
                >
                  {segmentLoading["returning_inactive_users"]
                    ? "Loading…"
                    : "View users"}
                </button>
              ...
              {segmentUsers["returning_inactive_users"] && (
                <div className="mt-2 bg-white border border-slate-200 rounded p-2 text-xs text-slate-700">
                  <div className="flex justify-between">
                    <span>Total:</span>
                    <span className="font-semibold">
                      {segmentUsers["returning_inactive_users"].totalCount}
                    </span>
                  </div>
                  {segmentUsers["returning_inactive_users"].sample.length >
                    0 && (
                    <ul className="mt-1 max-h-32 overflow-y-auto space-y-1">
                      {segmentUsers["returning_inactive_users"].sample.map(
                        (u) => (
                          <li key={u.id} className="flex justify-between">
                            <span>{u.name || u.email}</span>
                            <span className="text-slate-400">{u.plan}</span>
              ...
              <tbody className="divide-y divide-slate-200">
                <tr>
                  ...
                  <td className="px-4 py-3 text-slate-600">
                    Minimum days between showing the same campaign to a user.
                  </td>
                ...
                <tr>
                  ...
                  <td className="px-4 py-3 text-slate-600">
                    If a user dismisses a campaign, how long before showing it
                    again.
                  </td>
                ...
                <tr>
                  ...
                  <td className="px-4 py-3 text-slate-600">
                    Minimum time between ANY campaigns to prevent fatigue.
                  </td>
                ...
                <tr>
                  ...
                  <td className="px-4 py-3 text-slate-600">
                    If multiple campaigns match, which one is shown first.
                  </td>
