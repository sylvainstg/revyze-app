...
import { Trash2, RotateCcw, Clock, FolderOpen, AlertCircle } from 'lucide-react';
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-slate-500">
                                        {deletedProjects.length} {deletedProjects.length === 1 ? 'project' : 'projects'}
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 flex items-start gap-3">
                            ...
                            <div className="text-sm text-blue-800">
                                <p className="font-medium mb-1">Projects in trash are automatically deleted after 30 days</p>
                                <p className="text-blue-700">Restore projects before they're permanently deleted</p>
                            </div>
                        </div>
                                        ...
                                        <div className="flex items-start justify-between gap-4">
                                            <div className="flex-1 min-w-0">
                                                ...
                                                <div className="flex flex-wrap items-center gap-4 text-sm text-slate-500">
                                                    ...
                                                    <div className="flex items-center gap-1.5">
                                                        <span className={`px-2 py-0.5 rounded-full text-xs font-medium ${daysLeft <= 7
