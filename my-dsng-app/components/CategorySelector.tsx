            ...
            <div className="flex items-center gap-2 overflow-x-auto no-scrollbar">
                ...
                {categories.map((category) => (
                    <button
                        ...
                        className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-all whitespace-nowrap ${activeCategory === category
                    ...
                    >
                        ...
                        {category}
                        <span
                            className={`px-2 py-0.5 rounded-full text-xs font-bold ${activeCategory === category
