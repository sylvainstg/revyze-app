      ...
      <div className="max-w-2xl w-full bg-white rounded-3xl shadow-2xl overflow-hidden">
        ...
        <div className="p-12 text-center">
          ...
          <div className="relative inline-block mb-8">
            ...
            <Sparkles
              className="absolute -bottom-2 -left-2 w-6 h-6 text-purple-500 animate-pulse"
          ...
          <p className="text-slate-600 mb-8">
            {isPro ? (
              <>
                ...
                <span className="font-bold text-indigo-600">Pro</span>. You now
                have access to unlimited projects and AI analysis.
              </>
            ) : (
              <>
                You have successfully subscribed to the{" "}
                <span className="font-bold text-slate-700">Free Plan</span>. You
