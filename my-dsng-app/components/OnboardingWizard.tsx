      ...
      content: isInvited ? (
        <div className="space-y-4">
          <div className="bg-indigo-50 rounded-xl p-6 border border-indigo-100">
            ...
            <p className="text-slate-600 mt-3 text-sm">
              We'll guide you through the basics so you can start contributing
              right away.
            </p>
          </div>
          <div className="flex items-start gap-3 p-4 bg-slate-50 rounded-lg border border-slate-200">
            ...
            <p className="text-sm text-slate-700">
              After this quick tour, you'll be able to view the design, add
              comments, and collaborate with the team.
            </p>
          </div>
        </div>
      ) : (
        <div className="space-y-4">
          <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-xl p-6 border border-indigo-100">
            <p className="text-slate-700 leading-relaxed">
              Revyze is your collaborative design review platform. Share
          ...
          <div className="flex items-start gap-3 p-4 bg-slate-50 rounded-lg border border-slate-200">
            <Sparkles className="w-5 h-5 text-amber-500 flex-shrink-0 mt-0.5" />
            <p className="text-sm text-slate-700">
              Let's take a quick tour to get you started. You'll learn the
              essentials in just a few steps.
            </p>
          </div>
        </div>
      ),
        ...
        <div className="space-y-4">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600">
                    Use the arrow buttons or keyboard arrows to move between
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600">
                    Use the zoom buttons or scroll wheel to get a closer look at
                    design details.
                  </p>
                </div>
              </div>
          ...
          <div className="flex items-start gap-2 p-3 bg-blue-50 rounded-lg border border-blue-200">
            ...
            <p className="text-xs text-blue-900">
              <span className="font-semibold">Pro tip:</span> Click and drag to
              pan around the design when zoomed in.
            </p>
          </div>
        </div>
      ),
        ...
        <div className="space-y-4">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600">
                    Click anywhere on the design to add a comment. Your feedback
                    will be pinned to that exact spot.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600">
                    Have a conversation! Reply to comments to discuss changes
          ...
          <div className="flex items-start gap-2 p-3 bg-green-50 rounded-lg border border-green-200">
            ...
            <p className="text-xs text-green-900">
              <span className="font-semibold">Pro tip:</span> Comments are
              visible to everyone on the project, making collaboration seamless.
            </p>
          </div>
        </div>
      ),
        ...
        <div className="space-y-4">
          <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-xl p-6 border border-indigo-100">
            <p className="text-slate-700 leading-relaxed mb-4">
              Help your team know who's providing feedback by adding your name.
              This will appear on all your comments.
            </p>
            <Input
              label="Your Name"
              type="text"
      ...
      content: isInvited ? (
        <div className="space-y-4">
          <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-6 border border-green-200">
            <p className="text-slate-700 leading-relaxed">
              You're all set! We'll now open{" "}
              <span className="font-semibold text-green-900">
                {projectName}
              </span>{" "}
              so you can start reviewing and adding your feedback.
            </p>
          </div>
        ...
        <div className="space-y-4">
          <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-xl p-6 border border-indigo-100">
            <p className="text-slate-700 leading-relaxed">
              You're ready to go! Your next step is to create your first project
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-600 mt-0.5">
                  Upload a design and invite collaborators
                </p>
              </div>
            </div>
          </div>
