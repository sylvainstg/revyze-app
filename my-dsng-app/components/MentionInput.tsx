                ...
                <div className="absolute z-50 left-0 right-0 bottom-full mb-1 bg-white border border-slate-200 rounded-lg shadow-xl overflow-hidden max-h-48 overflow-y-auto">
                    ...
                    {suggestions.map((email, index) => (
                        <button
                            ...
                            className={`w-full text-left px-3 py-2 text-sm flex items-center gap-2 hover:bg-indigo-50 transition-colors ${index === activeSuggestionIndex ? 'bg-indigo-50 text-indigo-700' : 'text-slate-700'
                                }`}
                        >
