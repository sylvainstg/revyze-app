        ...
        <div className="flex gap-2 mb-3">
          <input
            ...
            value={
              referralCode
                ? getReferralLink()
                : "Click Copy to generate your link..."
            }
            readOnly
          ...
          {referralCode ? (
            <>
              ...
              <p className="text-xs text-indigo-700 mt-1">
                Share this link. When friends subscribe to a paid plan, you earn
                100 tokens!
              </p>
            </>
          ) : (
            <p className="text-xs text-indigo-700">
              Click "Copy" or "Share" to generate your unique referral link.
              When friends subscribe to a paid plan, you earn 100 tokens!
            </p>
          )}
        </div>
      </div>
