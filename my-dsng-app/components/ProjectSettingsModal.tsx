          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">
                Edit details and manage collaborators
              </p>
            </div>
          </div>
          <button
            ...
            {showDangerZone && (
              <div className="flex items-center justify-between mt-2 p-3 bg-red-50 rounded-xl border border-red-100 animate-in fade-in slide-in-from-top-1 duration-200">
                <div>
                  ...
                  <div className="text-xs text-red-500 max-w-[240px]">
                    Moves project to trash; collaborators lose access. This
                    action can be undone from the cemetery.
                  </div>
                </div>
                <Button
                  variant="danger"
