...
export const ONBOARDING_STEPS: OnboardingStep[] = [
  {
    ...
    description:
      "Use these arrows to move between pages in multi-page documents. You can also use your keyboard arrow keys.",
  ...
  },
  {
    ...
    title: "Zoom In & Out",
    description:
      "Get a closer look at design details with the zoom controls. You can also use your mouse wheel to zoom.",
  ...
  },
  {
    ...
    title: "Add Comments",
    description:
      "Click anywhere on the design to add your feedback. Your comments will be pinned to that exact location.",
  ...
  },
  {
    ...
    description:
      "All comments appear in this panel. Click on any comment to view details and join the discussion.",
  ...
  },
  {
    ...
    description:
      "Track changes over time. Upload new versions and switch between them to see how your design evolved.",
    position: "bottom",
  },
];
